...
const vi: Translation = {
  ...
  lesson: {
    ...
    createdDeadlineSuccessfully: 'Tạo deadline thành công!',
    createdDeadlineFailed: 'Tạo deadline thất bại!',
    editDeadline: 'Sửa đổi deadline',
    editedDeadlineSuccessfully: 'Sửa đổi deadline thành công!',
    editedDeadlineFailed: 'Sửa đổi deadline thất bại!',
    deleteDeadline: 'Xoá deadline',
    deleteDeadlineConfirmDescription: 'Bạn có chắc muốn xoá deadline này',
    deletedDeadlineSuccessfully: 'Xoá deadline thành công!',
    deletedDeadlineFailed: 'Xoá deadline thất bại!',
    addDeadlineFile: 'Thêm tập tin vào deadline',
    addedDeadlineFileSuccessfully: 'Thêm tập tin vào deadline thành công!',
    addedDeadlineFileFailed: 'Thêm tập tin vào deadline thất bại!',
    editDeadlineFile: 'Sửa đổi tập tin của deadline',
    editedDeadlineFileSuccessfully: 'Sửa đổi tập tin của deadline thành công!',
    editedDeadlineFileFailed: 'Sửa đổi tập tin của deadline thất bại!',
    deleteDeadlineFile: 'Xoá tập tin của deadline',
    deletedDeadlineFileSuccessfully: 'Xoá tập tin của deadline thành công!',
    deletedDeadlineFileFailed: 'Xoá tập tin của deadline thất bại!'
  },
  user: {
    overview: 'Tổng quan',
    courses: 'Khoá học',
